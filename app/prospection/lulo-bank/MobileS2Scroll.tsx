...
const LINES: Array<{ text: string; type: string; d: number }> = [
  { text: '$ kepler predict --semana 2026-W26', type: 'cmd',   d: 55 },
  { text: '',                                    type: 'blank', d: 28 },
  { text: '[init] Supabase: ultima_semana  OK',  type: 'ok',  d: 24 },
  { text: '[init] modelo v6 · XGBoost 1.7  OK',  type: 'ok',  d: 22 },
  { text: '',                                    type: 'blank', d: 28 },
  { text: '[fetch] Perplexity sonar-pro ...',    type: 'wait', d: 380 },
  { text: '[fetch] 15 fuentes ........  OK',     type: 'ok',  d: 50  },
  { text: '',                                    type: 'blank', d: 28 },

  { text: 'CONTEXTO DE MERCADO ──────────',      type: 'section', d: 50  },
  { text: '› BanRep 11.25% — sin recorte',        type: 'quote',   d: 140 },
  { text: '› Spread CDT vs inflación: máx.',      type: 'quote',   d: 130 },
  { text: '› Quincena 28-jun activa',             type: 'quote',   d: 110 },
  { text: 'fuentes: 15 · confianza: 94%',         type: 'meta',    d: 50  },
  { text: '',                                     type: 'blank',   d: 28  },

  { text: 'ANÁLISIS SHAP ────────────────',       type: 'section', d: 50  },
  { text: 'spread_cdt   +2.14σ ██████ CRÍT.',     type: 'sh_hi', d: 105 },
  { text: 'quincena     +1.78σ ████  IMPULSO',    type: 'sh_md', d: 92  },
  { text: 'colcap       +1.31σ ███   IMPULSO',    type: 'sh_md', d: 85  },
  ...
  { text: '──────────────────────────────',       type: 'div', d: 24  },
  { text: 'PREDICCIÓN → semana 2026-W26',         type: 'res', d: 380 },
  { text: 'usuarios_primer_cashin: 1,247',        type: 'num', d: 320 },
  { text: 'baseline 12s: 1,089   +14.5%',         type: 'sub', d: 130 },
  { text: 'ratio walk-forward: 1.51 ✓',           type: 'sub', d: 100 },
  { text: '──────────────────────────────',       type: 'div', d: 24  },
]
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '5px' }}>
                    <div style={{
                      ...
                      <span style={{ fontSize: '9.5px', fontWeight: 900, color: '#FFFFFF' }}>L</span>
                    </div>
                    <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '10px', fontWeight: 600 }}>Lulo Bank</span>
                    <span style={{ color: 'rgba(255,255,255,0.22)', fontSize: '9.5px', marginLeft: 'auto' }}>{n.time}</span>
                  </div>
                  <p style={{ color: 'rgba(255,255,255,0.84)', fontSize: '11px', lineHeight: 1.45, margin: 0 }}>{n.text}</p>
                </motion.div>
              ))}
            </div>
          </div>
